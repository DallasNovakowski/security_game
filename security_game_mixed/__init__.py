...
class scen_q(Page):
    form_model = 'player'
    form_fields = ['p_partner_envy','p_partner_jealous','p_partner_frustrated', 'p_partner_bitter']
...
class UVHS(Page):
    ...
    def is_displayed(self):
        return self.participant.vars['inequality'] == True and \
               self.round_number == self.participant.vars['task_rounds']['Sec_50_02_histak'] and \
               self.participant.vars['session_name'] == 'ineq_sec_stake'
...
class Sec_50_02(Page):
    ...
    def is_displayed(self):
        return self.round_number == self.participant.vars['task_rounds']['Sec_50_02']
...
class Sec_50_02_histak(Page):
    ...
    def is_displayed(self):
        return self.round_number == self.participant.vars['task_rounds']['Sec_50_02_histak'] and \
               self.participant.vars['session_name'] == 'ineq_sec_stake'
