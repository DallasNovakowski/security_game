...
SESSION_CONFIGS = [
    ...
    dict(
        ...
        app_sequence=["consent","survey", "intro_notask", "slider_task", 'merit_manip', 'security_game', 'attention_check', 'study_end'],
        completionlink='https://app.prolific.co/submissions/complete?cc=blahblah',
        endowment=2,
        lost_from_attacks=1,
        failed_attack=1,
    ...
    dict(
        ...
        num_demo_participants=10,
        app_sequence=["consent","survey","intro_notask", "group_manip", 'security_game', 'attention_check', 'study_end'],
        completionlink='https://app.prolific.co/submissions/complete?cc=blahblah',
        endowment=2,
        lost_from_attacks=1,
        failed_attack=1,
